    ...
    return (
        <section className="container mx-auto px-4 py-24">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 font-light">Ingénieur logiciel & développeur Java</p>
                <p className="text-lg text-slate-500 dark:text-slate-500 mb-12 max-w-2xl mx-auto leading-relaxed">
                 Je crée des systèmes performants et scalables.</p>
